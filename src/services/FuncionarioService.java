...
public class FuncionarioService {
    ...
    public void adicionarGestor() {
        ...
        gestores.add(g);
        System.out.println("Gestor cadastrado com sucesso! ID: " + g.getId());
    }
    ...
    public void adicionarFiscal() {
        ...
        fiscais.add(f);
        System.out.println("Fiscal cadastrado com sucesso! ID: " + f.getId());
    }
    ...
    public void listarGestores() {
        ...
        for (Gestor g : gestores) {
            System.out.printf("[%d] %s | Matrícula: %s | Setor: %s | Status: %s%n",
    ...
    public void alterarStatus() {
        System.out.println("\n=== ALTERAR STATUS DE FUNCIONÁRIO ===");
        System.out.println("Tipo: 1 - Gestor | 2 - Fiscal");
        ...
        if (tipo == 1) {
            ...
            if (g == null) { System.out.println("Gestor não encontrado."); return; }
            g.setAtivo(!g.isAtivo());
            System.out.println("Status atualizado: " + (g.isAtivo() ? "ATIVO" : "INATIVO"));
        } else {
            Fiscal f = buscarFiscalPorId(id);
            if (f == null) { System.out.println("Fiscal não encontrado."); return; }
