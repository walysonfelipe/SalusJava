 ...
 */
public class TelaLoginAdmin extends JPanel {
    ...
    public TelaLoginAdmin(Navegador navegador, FuncionarioServiceV2 funcService) {
    ...
    private void construir() {
        ...
        add(titulo("LOGIN — ADMINISTRADOR")); add(rigido(30));
